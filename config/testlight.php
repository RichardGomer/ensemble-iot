...
$bsched->setPoint('00:00:00', 'auto 50%');
$bsched->setPoint('05:00:00', 'auto 50%');
$bsched->setPoint('06:00:00', 'auto 100%');
$bsched->setPoint('22:00:00', 'auto 100%');
$bsched->setPoint('23:00:00', 'auto 50%');
...
$conf['devices'][] = $socket = new Light\RGBWCT("light1", $client, "light1", 'test.schedules', 'rainbowlightschedule');
