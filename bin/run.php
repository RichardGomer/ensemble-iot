...
function startBroker($conf) {
    ...
    // Skip if the default endpoint is our own because that's silly!
    if($conf['default_endpoint'] == $conf['endpoint_url']) {
        echo "Default endpoint is the same as our endpoint - not setting a default\n";
    }
    else {
